...
export default function Javascript(){
    return(
        ...
        >
            ...
            <h3 className="mb-4 text-2xl font-extrabold text-gray-900 dark:text-white md:text-5xl lg:text-5xl text-right">RS<span className="text-transparent bg-clip-text bg-gradient-to-r to-emerald-600 from-sky-400">50,00</span> a hora/aula.</h3>
