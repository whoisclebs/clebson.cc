...
programação</h1>
            ...
            <div className="px-4 mx-auto max-w-screen-xl lg:px-6 ">
                <div className="grid gap-8 mb-6 lg:mb-16 md:grid-cols-4">
                    {aulas.subjects.map((subject, index) => (
                        ...
                        <a href="#">
                            <img className="w-full rounded-lg sm:rounded-none sm:rounded-l-lg" src={subject.img} alt={subject.alt}/>
                        </a>
                        <div className="p-5">
            ...
            <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
                ...
                <form action="#" className="space-y-8">
                    <div>
                        <label for="email" className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Seu melhor e-mail</label>
