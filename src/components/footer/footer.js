...
export default function Footer() {
    return (
        ...
        <div className="container flex flex-wrap justify-center md:justify-between items-center mx-auto  border-t  border-gray-200 p-4">
            <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© { new Date().getFullYear() } <a href="https://clebson.cc/" className="hover:underline">Clebson Augusto Fonseca</a>. Todos direitos reservados.
            </span>
